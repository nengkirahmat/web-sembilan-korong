				...
				<div class="container">
					<div class="row">
						<div class="col-sm-4 col-sm-offset-4 form-box">
							<div class="form-top" style="background: #ffffffa1;">
								<a href="<?=site_url(); ?>"><img style="max-width: 150px;" src="<?=gambar_desa($header['logo']);?>" alt="<?=$header['nama_desa']?>" class="img-responsive" /></a>
							...
							<div class="form-bottom" style="background: #ffffffa1;">
